...
import { 
  ...
  Compass, Tag, Brain, Clock, GraduationCap, Presentation, Eye, EyeOff, Award, History
} from "lucide-react";
                ...
                <div className="p-4 bg-amber-50 border border-amber-200 rounded-2xl space-y-2.5 shadow-xs">
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-amber-900 hover:bg-amber-950 text-white rounded-lg text-xs font-semibold shadow-2xs transition-all cursor-pointer"
                    >
